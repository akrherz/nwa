...
# First mesh point
ARCHIVE_T0 = datetime.datetime(2017, 6, 28, 20, 30)
ARCHIVE_T0 = ARCHIVE_T0.replace(tzinfo=pytz.utc)
RT_T0 = datetime.datetime(2018, 3, 22, 19, 0)  # 2:00 PM
RT_T0 = RT_T0.replace(tzinfo=pytz.utc)
# Second mesh point
ARCHIVE_T1 = datetime.datetime(2017, 6, 28, 23, 30)
ARCHIVE_T1 = ARCHIVE_T1.replace(tzinfo=pytz.utc)
